...
export default function TemplatesList({ templates, onOpenEditor, reviewByTemplateId,  }) {
  return (
    <div className="rounded-xl border border-gray-200 bg-white">
      ...
      <div className="divide-y">
        {templates.map((t, idx) => {
          const reviewState = reviewByTemplateId?.[t.id] || { status: "needs-review", decision: null };
            ...
            >
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  <div className="text-xs font-semibold text-gray-400">{String(idx + 1).padStart(2, "0")}</div>
                ...
                <div className="mt-1 text-xs text-gray-500">JSON Schema (mock data, will connect to DB)</div>
              </div>
